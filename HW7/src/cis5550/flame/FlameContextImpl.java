...
public class  FlameContextImpl implements FlameContext {
	...
	public FlameRDD fromTable(String tableName, RowToString lambda) throws Exception {
		...
		String outputtable = fc.invokeOperation("/rdd/fromTable",Serializer.objectToByteArray(lambda), tableName,null);
		return new FlameRDDImpl(outputtable,Coordinator.kvs);
	}
